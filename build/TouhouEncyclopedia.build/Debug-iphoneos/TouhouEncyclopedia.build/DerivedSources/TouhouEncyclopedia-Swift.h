...
SWIFT_CLASS("_TtC18TouhouEncyclopedia11AppDelegate")
@interface AppDelegate : UIResponder <UIApplicationDelegate>
@property (nonatomic, strong) UIWindow * _Nullable window;
@property (nonatomic, readonly) NSInteger exceptionTitle;
...
- (BOOL)CheckUpdated SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic) NSInteger m_displayTabIndex;
@property (nonatomic, copy) NSString * _Nonnull m_barTitle;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
